...
> [!TIP]
> 如果你的浏览器支持[文档画中画](https://developer.mozilla.org/zh-CN/docs/Web/API/Document_Picture-in-Picture_API)，你可以开启画中画字幕以实现在浏览器外部也能无缝查看。
...
Neokikoeru 支持删除作品的同时删除源文件，相关策略如下：
...
![delete-work](/images/delete-work.webp)

> [!CAUTION]
> 当存储驱动为「本地存储」时，文件会被彻底删除，无法恢复，请小心操作！
