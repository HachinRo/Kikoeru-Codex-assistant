...
asmr-library
    ...
    |                              |
    |                              v
    |                  /Volumes/TOSHIBA/AMSR.incoming
    |                              |
    |                    validate + atomic rename
    |                              |
    |                              v
    |                     /Volumes/TOSHIBA/AMSR/RJ...
    |
...
```text
~/.hermes/asmr/.asmroner-data/config.toml
~/.hermes/asmr/.asmroner-data/asmroner.db
~/.hermes/asmr/.asmroner-data/download_errors.log
```
...
- locks per RJ;
- stages under `/Volumes/TOSHIBA/AMSR.incoming`;
...
~/.hermes/asmr/bin/asmr-library retry RJ01234567
~/.hermes/asmr/bin/asmr-library fill RJ01234567
...
```sh
~/.hermes/asmr/bin/asmr-library subs fetch RJ01234567 --dry-run
```
